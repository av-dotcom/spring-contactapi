package com.fullstack_contact_app.contactapi.resource;

import com.fullstack_contact_app.contactapi.domain.Contact;
import com.fullstack_contact_app.contactapi.service.ContactService;
...
public class ContactResource {
    ...
    public ResponseEntity<String> deleteContact(@PathVariable("id") String id) {
        ...
        return ResponseEntity.ok("Contact with ID " + id + " was successfully deleted.");
    }
